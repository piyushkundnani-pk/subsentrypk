      ...
      try {
        ...
        const emailHtml = `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <p style="color: #374151; font-size: 16px; line-height: 1.5;">
              This is a friendly reminder that your <strong>${escapeHtml(subscription.name)}</strong> subscription is renewing ${daysUntil === 0 ? 'today' : daysUntil < 0 ? `${Math.abs(daysUntil)} days ago` : `in ${daysUntil} ${daysUntil === 1 ? 'day' : 'days'}`}.
            </p>
